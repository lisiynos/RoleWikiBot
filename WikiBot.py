...
*3. Разорители* 👽
_Задача:_ слить как можно больше денег (собрать отрицательный капитал). 
Возможность выступать на суде одновременно и подсудимым и адвокатом.
*4. Мирные* 👦👧
_Задача:_ собрать капитал. 
Есть возможность подать прошение (платно) на рассмотрение дела по подозрению определенного 
человека в разорении. 
*5. Разработчик* 🚀
